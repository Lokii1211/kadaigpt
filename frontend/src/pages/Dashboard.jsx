...
export default function Dashboard({ addToast, setCurrentPage }) {
    ...
    return (
        ...
        .live-time { display: flex; align-items: center; gap: 8px; padding: 8px 16px; background: var(--bg-card); border: 1px solid var(--border-subtle); border-radius: var(--radius-lg); font-weight: 600; font-size: 1.125rem; }
        ...
        .quick-action-btn {
          ...
          gap: 8px; padding: 20px; background: var(--bg-card);
          border: 2px solid var(--border-subtle); border-radius: var(--radius-xl);
          cursor: pointer; transition: all var(--transition-fast);
          font-weight: 600; color: var(--text-secondary);
        }
        .quick-action-btn:hover { border-color: var(--primary-400); color: var(--primary-400); transform: translateY(-2px); }
        .quick-action-btn.primary { background: var(--gradient-primary); color: white; border: none; }
        .quick-action-btn.primary:hover { opacity: 0.9; }
        ...
        .stat-icon { width: 56px; height: 56px; background: var(--bg-tertiary); border-radius: var(--radius-lg); display: flex; align-items: center; justify-content: center; color: var(--primary-400); }
        ...
        .stat-change { display: flex; align-items: center; gap: 4px; font-size: 0.8125rem; font-weight: 600; position: absolute; top: 16px; right: 16px; }
        .stat-change.positive { color: var(--success); }
        .stat-card.highlight .stat-change { color: rgba(255,255,255,0.9); }

        .dashboard-grid { display: grid; grid-template-columns: 1.5fr 1fr; gap: 24px; margin-bottom: 24px; }
        @media (max-width: 1024px) { .dashboard-grid { grid-template-columns: 1fr; } }

        .chart-card .chart-container { padding: 20px 0; }
        .area-chart { height: 200px; }
        .chart-bars { display: flex; align-items: flex-end; justify-content: space-between; height: 100%; gap: 4px; padding: 0 10px; }
        ...
        .bar-tooltip { 
          ...
          transition: opacity var(--transition-fast); margin-bottom: 4px;
        }
        .chart-bar:hover .bar-tooltip { opacity: 1; }
        .bar-label { font-size: 0.625rem; color: var(--text-tertiary); margin-top: 8px; }
        .chart-summary { display: flex; gap: 24px; padding-top: 16px; border-top: 1px solid var(--border-subtle); }
        .summary-item .label { font-size: 0.75rem; color: var(--text-tertiary); display: block; }
        ...
        .activity-item { display: flex; align-items: flex-start; gap: 12px; padding: 12px; background: var(--bg-tertiary); border-radius: var(--radius-md); }
        ...
        .activity-content p { margin: 0 0 4px; font-size: 0.875rem; }
        ...
        .low-stock-item { display: flex; justify-content: space-between; align-items: center; padding: 12px; background: var(--bg-tertiary); border-radius: var(--radius-md); }
        .product-name { font-weight: 500; display: block; }
        .product-category { font-size: 0.75rem; color: var(--text-tertiary); }
        .stock-info { text-align: right; min-width: 100px; }
        .stock-level { font-size: 0.8125rem; display: block; margin-bottom: 4px; }
        ...
        .stock-fill { height: 100%; background: var(--warning); border-radius: 2px; }

        .amount { font-weight: 600; color: var(--primary-400); }

        .ai-insights-banner {
          display: flex; align-items: center; gap: 20px;
          padding: 24px; background: linear-gradient(135deg, rgba(249, 115, 22, 0.1) 0%, rgba(234, 88, 12, 0.1) 100%);
          border: 1px solid var(--primary-400); border-radius: var(--radius-xl);
        }
        .ai-icon { width: 56px; height: 56px; background: var(--gradient-primary); border-radius: var(--radius-lg); display: flex; align-items: center; justify-content: center; color: white; }
        .ai-content { flex: 1; }
        .ai-content h4 { margin: 0 0 4px; color: var(--primary-400); }
        .ai-content p { margin: 0; color: var(--text-secondary); }
      `}</style>
        </div>
    )
}
